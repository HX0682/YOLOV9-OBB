...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / r'datasets/my_data.yaml', help='数据集配置文件路径。')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp20/weights/best.pt', help='模型权重文件路径,一般需要替换成你自己训练的权重')
    parser.add_argument('--batch-size', type=int, default=1, help='批处理大小,一次验证图片的多少，影响验证速度')
    ...
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu，使用的CUDA设备，例如0或0,1,2,3或cpu。')
