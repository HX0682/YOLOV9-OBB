...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/detect/yolov9-e.yaml', help='模型的配置文件,我们可以根据自己需求配置yaml文件')
    parser.add_argument('--data', type=str, default=ROOT / 'datasets/my_data.yaml', help='大家的数据集yaml文件的地址')
    ...
    parser.add_argument('--epochs', type=int, default=500, help='训练的轮次')
