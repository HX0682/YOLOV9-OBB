...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'datasets/my_data.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--conf-thres', type=float, default=0.0001, help='confidence threshold')
